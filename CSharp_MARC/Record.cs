...
namespace MARC
{
    ...
    public class Record
    {
        ...
        public Field this[string tag] => Fields.FirstOrDefault(f => f.Tag == tag);
		...
		public IEnumerable<Field> GetFields(string tag)
			=> string.IsNullOrEmpty(tag) ? Fields : Fields.Where(f => f.Tag == tag);
