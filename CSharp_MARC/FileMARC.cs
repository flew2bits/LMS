...
namespace MARC
{
    ...
    /// </summary>
    public class FileMARC : IEnumerator<Record>, IEnumerable<Record>
    {
        //Constants
        #region Constants
        ...
        private Record decode(int index)
        {
            ...
            try
            {
                ...
                if (match.Captures.Count == 0)
                {
                    ...
                    recordLength = Convert.ToInt32(match.Captures[0].Value, CultureInfo.InvariantCulture);
                ...
                if (!raw.EndsWith(END_OF_RECORD.ToString(), StringComparison.InvariantCulture))
        ...
        public Record Current => this[position];
